...
define private fastcc i64 addrspace(1)* @isOdd1(i64 addrspace(1)* %x) gc "statepoint-example"{
; <label>:0:
...
cond2:
  ...
  %11 = call fastcc i64 addrspace(1)* @isEven2(i64 addrspace(1)* %10)
  br label %end
end:
...
define private fastcc i64 addrspace(1)* @isEven2(i64 addrspace(1)* %x) gc "statepoint-example"{
; <label>:0:
  %1 = call ccc i8 addrspace(1)* @alloc(i64 8)
  %2 = bitcast i8 addrspace(1)* %1 to i64 addrspace(1)*
  store i64 0, i64 addrspace(1)* %2, align 8
...
cond2:
  ...
  store i64 1, i64 addrspace(1)* %9, align 8
  %10 = call fastcc i64 addrspace(1)* @-(i64 addrspace(1)* %x, i64 addrspace(1)* %9)
  %11 = call fastcc i64 addrspace(1)* @isOdd1(i64 addrspace(1)* %10)
  br label %end
end:
  %12 = phi i64 addrspace(1)* [%7, %cond], [%11, %cond2]
  ret i64 addrspace(1)* %12
...
define private fastcc i64 addrspace(1)* @f3(i8* %x) gc "statepoint-example"{
  %1 = call ccc i8 addrspace(1)* @alloc(i64 8)
  %2 = bitcast i8 addrspace(1)* %1 to i64 addrspace(1)*
...
define private fastcc i64 addrspace(1)* @g4(i64 addrspace(1)* %x) gc "statepoint-example"{
  %1 = call ccc i8 addrspace(1)* @alloc(i64 8)
  %2 = bitcast i8 addrspace(1)* %1 to i64 addrspace(1)*
...
define private fastcc i64 addrspace(1)* @fib5(i64 addrspace(1)* %x) gc "statepoint-example"{
; <label>:0:
  %1 = call ccc i8 addrspace(1)* @alloc(i64 8)
  %2 = bitcast i8 addrspace(1)* %1 to i64 addrspace(1)*
  store i64 0, i64 addrspace(1)* %2, align 8
...
cond4:
  ...
  %18 = call fastcc i64 addrspace(1)* @fib5(i64 addrspace(1)* %17)
  ...
  %22 = call fastcc i64 addrspace(1)* @fib5(i64 addrspace(1)* %21)
...
define private fastcc i64 addrspace(1)* @userMain() gc "statepoint-example"{
  ...
  %3 = call fastcc i64 addrspace(1)* @fib5(i64 addrspace(1)* %2)
